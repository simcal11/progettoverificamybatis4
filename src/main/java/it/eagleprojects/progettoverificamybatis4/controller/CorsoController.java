...
public class CorsoController {
	...
	public @ResponseBody List<Corso> getAllCorsiByStudenteId(@PathVariable("studenteId") long studenteId) throws Exception {
	...
	public @ResponseBody Corso updateCorsoById(@PathVariable("corsoId") long corsoId, @RequestBody Corso corsoRequest) throws Exception {
	...
	public @ResponseBody void addCorsoToStudente(@PathVariable(value = "studenteId") long studenteId, @RequestBody Corso corso) throws Exception {
	...
	public @ResponseBody void deleteCorsoFromStudente(@PathVariable(value = "studenteId") Long studenteId, @RequestBody Corso corso) throws Exception {
