...
public class StudenteController {
	...
	public @ResponseBody  List<Studente> getAllStudentiByCorsoId(@PathVariable("corsoId") Long corsoId) throws Exception {
	...
	public @ResponseBody Studente updateStudenteById(@PathVariable("studenteId") Long studenteId, @RequestBody Studente studenteRequest) throws Exception {
	...
	public @ResponseBody void addStudenteToCorso(@PathVariable(value = "corsoId") Long corsoId, @RequestBody Studente studente) throws Exception {
	...
	public @ResponseBody void deleteStudenteFromCorso(@PathVariable(value = "corsoId") Long corsoId, @RequestBody Studente studente) throws Exception {
